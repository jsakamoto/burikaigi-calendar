# BuriKaigi Calendar [![tests](https://github.com/jsakamoto/burikaigi-calendar/actions/workflows/tests.yml/badge.svg)](https://github.com/jsakamoto/burikaigi-calendar/actions/workflows/tests.yml)
